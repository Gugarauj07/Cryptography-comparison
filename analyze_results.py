#!/usr/bin/env python3
"""
Visualização dos Resultados do Benchmark AES vs Blowfish
"""
...
def load_latest_results():
    """Carrega o arquivo mais recente de resultados"""
...
def create_comparison_chart(results):
    """Cria gráfico comparativo de tempo de criptografia"""
...
def save_summary_table(results):
    """Salva tabela resumo dos resultados"""
